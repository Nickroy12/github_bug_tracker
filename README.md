...
## var is global container(memory) where anyone can change value or redeclared  the variables. let is one type variable which can only change value but cannot redeclared . On the other hand , constant or const variable  contains the value permanently also cannot redeclared.

# 2 What is the spread operator (...)?
## spread operator one kind of method which can make shallow copy of array , Object 
